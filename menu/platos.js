...
const ITEMS = {
  ...
  rucula:         { n: 'Rúcula',                     u: 'porc', cat: 'verduras' },
  cherry:         { n: 'Tomate cherry',              u: 'porc', cat: 'verduras' },
  brocoli:        { n: 'Brócoli',                    u: 'porc', cat: 'verduras' },
  ...
  lucuma:         { n: 'Pulpa de lúcuma',            u: 'porc', cat: 'frutas' },
  ...
  noquis:         { n: 'Ñoquis',                     u: 'taza', cat: 'abarrotes' },
  ...
  proteina:       { n: 'Proteína en polvo',          u: 'scoop',cat: 'abarrotes' },
  chia:           { n: 'Chía o linaza',              u: 'cda',  cat: 'abarrotes' },
  mani:           { n: 'Mantequilla de maní natural',u: 'cdta', cat: 'abarrotes' },
