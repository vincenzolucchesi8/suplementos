...
const ITEMS = {
  ...
  atun_lata:      { n: 'Atún al natural (lata)',     u: 'lata', cat: 'proteina' },
  pavo_lonchas:   { n: 'Pavo en lonchas',            u: 'lon',  cat: 'proteina' },
  jamon_lonchas:  { n: 'Jamón cocido en lonchas',    u: 'lon',  cat: 'proteina' },
  ...
  yogurt_prot:    { n: 'Yogurt proteico (Vakimu PRO o Quark)', u: 'cda', cat: 'lacteos', compra: { u: 'g', factor: 15, paso: 250 } },
  yogurt_indiv:   { n: 'Yogurt proteico individual', u: 'u',    cat: 'lacteos' },
  leche:          { n: 'Leche',                      u: 'vaso', cat: 'lacteos', compra: { u: 'ml', factor: 250, paso: 500 } },

  // Verduras
  lechuga:        { n: 'Lechuga',                    u: 'porc', cat: 'verduras', compra: { u: 'u', factor: 0.5, paso: 1 } },
  tomate:         { n: 'Tomate',                     u: 'u',    cat: 'verduras' },
  pepino:         { n: 'Pepino',                     u: 'u',    cat: 'verduras' },
  cebolla:        { n: 'Cebolla roja',               u: 'u',    cat: 'verduras' },
  rucula:         { n: 'Rúcula',                     u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 60, paso: 100 } },
  cherry:         { n: 'Tomate cherry',              u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 80, paso: 250 } },
  brocoli:        { n: 'Brócoli',                    u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 150, paso: 250 } },
  zanahoria:      { n: 'Zanahoria',                  u: 'u',    cat: 'verduras' },
  vainita:        { n: 'Vainitas',                   u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 100, paso: 250 } },
  zapallito:      { n: 'Zapallito italiano',         u: 'u',    cat: 'verduras' },
  esparrago:      { n: 'Espárragos',                 u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 120, paso: 250 } },
  coliflor:       { n: 'Coliflor',                   u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 200, paso: 250 } },
  betarraga:      { n: 'Betarraga',                  u: 'u',    cat: 'verduras' },
  espinaca:       { n: 'Espinaca',                   u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 80, paso: 100 } },
  champinon:      { n: 'Champiñones',                u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 80, paso: 100 } },
  palta:          { n: 'Palta pequeña',              u: 'u',    cat: 'verduras' },
  aceituna:       { n: 'Aceitunas',                  u: 'porc', cat: 'verduras', compra: { u: 'g', factor: 30, paso: 100 } },
  limon:          { n: 'Limón',                      u: 'u',    cat: 'verduras' },

  // Frutas
  manzana:        { n: 'Manzana',                    u: 'u',    cat: 'frutas' },
  platano:        { n: 'Plátano',                    u: 'u',    cat: 'frutas' },
  mango:          { n: 'Mango',                      u: 'u',    cat: 'frutas' },
  uva:            { n: 'Uvas',                       u: 'porc', cat: 'frutas', compra: { u: 'g', factor: 150, paso: 250 } },
  mandarina:      { n: 'Mandarina',                  u: 'u',    cat: 'frutas' },
  papaya:         { n: 'Papaya',                     u: 'porc', cat: 'frutas', compra: { u: 'g', factor: 200, paso: 500 } },
  lucuma:         { n: 'Pulpa de lúcuma',            u: 'porc', cat: 'frutas', compra: { u: 'g', factor: 100, paso: 250 } },

  // Abarrotes
  quinoa:         { n: 'Quinoa',                     u: 'taza', cat: 'abarrotes', compra: { u: 'g', factor: 60, paso: 100 } },
  lenteja:        { n: 'Lentejas',                   u: 'taza', cat: 'abarrotes', compra: { u: 'g', factor: 70, paso: 250 } },
  garbanzo:       { n: 'Garbanzos',                  u: 'taza', cat: 'abarrotes', compra: { u: 'g', factor: 70, paso: 250 } },
  frejol:         { n: 'Frejol canario',             u: 'taza', cat: 'abarrotes', compra: { u: 'g', factor: 70, paso: 250 } },
  papa:           { n: 'Papa pequeña',               u: 'u',    cat: 'abarrotes' },
  camote:         { n: 'Camote mediano',             u: 'u',    cat: 'abarrotes' },
  noquis:         { n: 'Ñoquis',                     u: 'taza', cat: 'abarrotes', compra: { u: 'g', factor: 150, paso: 250 } },
  wrap:           { n: 'Wrap integral',              u: 'u',    cat: 'abarrotes' },
  salmas:         { n: 'Salmas (paquete)',           u: 'paq',  cat: 'abarrotes' },
  granola:        { n: 'Granola (Huella Verde o Amaru)', u: 'cda', cat: 'abarrotes', compra: { u: 'g', factor: 12, paso: 100 } },
  proteina:       { n: 'Proteína en polvo',          u: 'scoop',cat: 'abarrotes', compra: { u: 'g', factor: 30, paso: 100 } },
  chia:           { n: 'Chía o linaza',              u: 'cda',  cat: 'abarrotes', compra: { u: 'g', factor: 12, paso: 50 } },
...
const DESAYUNOS = [
  { id:'d_omelette_esp',  t:'Omelette de 3 huevos con mozzarella y espinaca',
    d:'Con media palta pequeña y 1 paquete de salmas si te provoca',
    tags:['huevos'], ing:[['huevo',3],['mozzarella',2],['espinaca',1],['palta',0.5]] },
  { id:'d_omelette_champ',t:'Omelette de 3 huevos con mozzarella y champiñones',
    d:'Con media palta pequeña y 1 paquete de salmas si te provoca',
    tags:['huevos'], ing:[['huevo',3],['mozzarella',2],['champinon',1],['palta',0.5]] },
  { id:'d_revueltos_pavo',t:'Huevos revueltos con pavo',
    d:'3 huevos con 2 lonchas de pavo, media palta pequeña y 1 fruta',
    tags:['huevos','fruta'], ing:[['huevo',3],['pavo_lonchas',2],['palta',0.5],['manzana',1]] },
  { id:'d_revueltos_jamón',t:'Huevos revueltos con jamón cocido',
    d:'3 huevos con 2 lonchas de jamón, media palta pequeña y 1 fruta',
...
const PROT_ALM = [
  { id:'p_pollo_plancha', k:'pollo',   corto:'Pollo a la plancha', t:'2 filetes medianos de pollo a la plancha', ing:[['pollo_filete',2]] },
  { id:'p_pollo_horno',   k:'pollo',   corto:'Pollo al horno con hierbas', t:'2 filetes medianos de pollo al horno con hierbas', ing:[['pollo_filete',2]] },
  { id:'p_pollo_sudado',  k:'pollo',   corto:'Pollo sudado con tomate y cebolla', t:'2 filetes medianos de pollo sudados con tomate y cebolla', ing:[['pollo_filete',2],['tomate',1],['cebolla',0.5]] },
  { id:'p_bonito',        k:'pescado', corto:'Bonito a la plancha', t:'1 filete grande de bonito a la plancha', ing:[['bonito',1]] },
  { id:'p_trucha',        k:'pescado', corto:'Trucha al horno', t:'1 filete grande de trucha al horno', ing:[['trucha',1]] },
  { id:'p_perico',        k:'pescado', corto:'Perico a la plancha', t:'1 filete grande de perico a la plancha', ing:[['perico',1]] },
  { id:'p_jurel',         k:'pescado', corto:'Jurel al horno', t:'1 filete grande de jurel al horno', ing:[['jurel',1]] },
  { id:'p_merluza',       k:'pescado', corto:'Merluza al vapor', t:'1 filete grande de merluza al vapor', ing:[['merluza',1]] },
  { id:'p_atun',          k:'atun',    corto:'Atún con huevo cocido', t:'1 lata de atún al natural y 1 huevo cocido', ing:[['atun_lata',1],['huevo',1]] },
  { id:'p_res',           k:'carne',   corto:'Res a la plancha', t:'1 filete grande de res a la plancha', ing:[['res_filete',1]] },
  { id:'p_lomo',          k:'carne',   corto:'Lomo a la plancha', t:'1 filete grande de lomo a la plancha', ing:[['lomo_filete',1]] },
];
...
const CARB_ALM = [
  ...
  { id:'c_papa',      k:'otro',      t:'1 papa pequeña sancochada',      ing:[['papa',1]] },
  { id:'c_camote',    k:'otro',      t:'Medio camote mediano al horno',  ing:[['camote',0.5]] },
  { id:'c_ñoquis',    k:'otro',      t:'1 taza de ñoquis',               ing:[['noquis',1]] },
];
const CARB_CEN = [
  { id:'cc_quinoa', k:'quinoa', t:'Tres cuartos de taza de quinoa cocida', ing:[['quinoa',0.75]] },
  { id:'cc_papa',   k:'otro',   t:'Media papa pequeña sancochada',         ing:[['papa',0.5]] },
  { id:'cc_ñoquis', k:'otro',   t:'Tres cuartos de taza de ñoquis',        ing:[['noquis',0.75]] },
];

// ---- Grasas del almuerzo. En la cena opcion plato NO va grasa extra (pagina 8)
const GRASA_ALM = [
  { id:'g_palta',     t:'Media palta pequeña',  ing:[['palta',0.5]] },
...
const VERDURAS = [
  ...
  { id:'v_esparrago', t:'Espárragos y zanahoria al horno',                 ing:[['esparrago',1],['zanahoria',1],['aceite',1]] },
  ...
  { id:'v_espinaca',  t:'Espinaca salteada con champiñones',               ing:[['espinaca',1],['champinon',1],['aceite',1]] },
];

// ---- Cena opcion omelette (pagina 8)
const OMELETTES = [
  { id:'o_champ',   corto:'Omelette con champiñones', t:'Omelette de 3 huevos con champiñones',
    d:'Con media palta pequeña. Si tienes hambre, 1 wrap integral o 1 paquete de salmas',
    ing:[['huevo',3],['champinon',1],['palta',0.5]] },
  { id:'o_espinaca',corto:'Omelette con espinaca y tomate', t:'Omelette de 3 huevos con espinaca y tomate',
    d:'Con 2 lonchas de gouda. Si tienes hambre, 1 wrap integral o 1 paquete de salmas',
    ing:[['huevo',3],['espinaca',1],['tomate',1],['gouda',2]] },
  { id:'o_verduras',corto:'Omelette con zapallito y tomate', t:'Omelette de 3 huevos con zapallito y tomate',
    d:'Con media palta pequeña. Si tienes hambre, 1 wrap integral o 1 paquete de salmas',
...
const MEDIA_MANANA = [
  { t:'1 fruta y 1 puñado de frutos secos (12 a 15 unidades)', ing:[['manzana',1],['frutos_secos',1]] },
  { t:'1 trocito de chocolate >70% y 1 puñado de frutos secos', ing:[['chocolate',1],['frutos_secos',1]] },
  { t:'1 yogurt proteico individual de sabor', ing:[['yogurt_indiv',1]] },
  { t:'1 café o infusion con 1 trocito de chocolate >70%', ing:[['chocolate',1]] },
];
const MERIENDA = [
